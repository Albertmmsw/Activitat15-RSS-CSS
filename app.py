...
def get_rss_elpuntavui(seccio):
    urls_rss = {
        "portada": "https://www.elpuntavui.cat/barcelona.feed?type=rss",
        "politica": "https://www.elpuntavui.cat/politica.feed?type=rss",
        "economia": "https://www.elpuntavui.cat/economia.feed?type=rss",
        "societat": "https://www.elpuntavui.cat/societat.feed?type=rss",
        "cultura": "https://www.elpuntavui.cat/cultura.feed?type=rss",
    }

    xml = urls_rss.get(seccio, "https://www.elpuntavui.cat/portada.feed?type=rss")  # Fallback si la secció no existeix
    rss = feedparser.parse(xml)
    return rss
